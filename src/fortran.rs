...
pub fn strcon(norm: u8, uplo: u8, diag: u8, n: usize, a: &[f32], lda: usize, rcond: &mut f32,
    ...
    unsafe {
        ffi::strcon_(&(norm as c_char), &(uplo as c_char), &(diag as c_char), &(n as c_int),
                     a.as_ptr(), &(lda as c_int), rcond, work.as_mut_ptr(), iwork.as_mut_ptr(),
                     info)
    }
}
...
pub fn ctrcon(norm: u8, uplo: u8, diag: u8, n: usize, a: &[c32], lda: usize, rcond: &mut f32,
    ...
    unsafe {
        ffi::ctrcon_(&(norm as c_char), &(uplo as c_char), &(diag as c_char), &(n as c_int),
                     a.as_ptr() as *const _, &(lda as c_int), rcond, work.as_mut_ptr() as *mut _,
                     rwork.as_mut_ptr(), info)
    }
}
...
pub fn stpcon(norm: u8, uplo: u8, diag: u8, n: usize, ap: &[f32], rcond: &mut f32,
    ...
    unsafe {
        ffi::stpcon_(&(norm as c_char), &(uplo as c_char), &(diag as c_char), &(n as c_int),
                     ap.as_ptr(), rcond, work.as_mut_ptr(), iwork.as_mut_ptr(), info)
    }
}
...
pub fn stbcon(norm: u8, uplo: u8, diag: u8, n: usize, kd: usize, ab: &[f32], ldab: usize,
    ...
    unsafe {
        ffi::stbcon_(&(norm as c_char), &(uplo as c_char), &(diag as c_char), &(n as c_int),
                     &(kd as c_int), ab.as_ptr(), &(ldab as c_int), rcond, work.as_mut_ptr(),
                     iwork.as_mut_ptr(), info)
    }
}
...
pub fn ctbcon(norm: u8, uplo: u8, diag: u8, n: usize, kd: usize, ab: &[c32], ldab: usize,
    ...
    unsafe {
        ffi::ctbcon_(&(norm as c_char), &(uplo as c_char), &(diag as c_char), &(n as c_int),
                     &(kd as c_int), ab.as_ptr() as *const _, &(ldab as c_int), rcond,
                     work.as_mut_ptr() as *mut _, rwork.as_mut_ptr(), info)
    }
}
...
pub fn sgerfsx(trans: u8, equed: u8, n: usize, nrhs: usize, a: &[f32], lda: usize, af: &[f32],
    ...
    unsafe {
        ffi::sgerfsx_(&(trans as c_char), &(equed as c_char), &(n as c_int), &(nrhs as c_int),
                      ...
                      &(ldx as c_int), rcond, berr.as_mut_ptr(), n_err_bnds.as_ptr(),
...
pub fn sgbrfsx(trans: u8, equed: u8, n: usize, kl: usize, ku: usize, nrhs: usize, ab: &[f32],
               ...
               b: &[f32], ldb: usize, x: &mut [f32], ldx: usize, rcond: &mut f32, berr: &mut [f32],
    ...
    unsafe {
        ffi::sgbrfsx_(&(trans as c_char), &(equed as c_char), &(n as c_int), &(kl as c_int),
                      ...
                      b.as_ptr(), &(ldb as c_int), x.as_mut_ptr(), &(ldx as c_int), rcond,
...
pub fn dgbrfsx(trans: u8, equed: u8, n: usize, kl: usize, ku: usize, nrhs: usize, ab: &[f64],
               ...
               b: &[f64], ldb: usize, x: &mut [f64], ldx: usize, rcond: &mut f64, berr: &mut [f64],
...
pub fn cgbrfsx(trans: u8, equed: u8, n: usize, kl: usize, ku: usize, nrhs: usize, ab: &[c32],
               ...
               b: &[c32], ldb: usize, x: &mut [c32], ldx: usize, rcond: &mut f32, berr: &mut [f32],
               n_err_bnds: &[i32], err_bnds_norm: &mut [f32], err_bnds_comp: &mut [f32],
    ...
    unsafe {
        ffi::cgbrfsx_(&(trans as c_char), &(equed as c_char), &(n as c_int), &(kl as c_int),
                      ...
                      x.as_mut_ptr() as *mut _, &(ldx as c_int), rcond, berr.as_mut_ptr(),
...
pub fn zgbrfsx(trans: u8, equed: u8, n: usize, kl: usize, ku: usize, nrhs: usize, ab: &[c64],
               ...
               b: &[c64], ldb: usize, x: &mut [c64], ldx: usize, rcond: &mut f64, berr: &mut [f64],
               n_err_bnds: &[i32], err_bnds_norm: &mut [f64], err_bnds_comp: &mut [f64],
...
pub fn ssyrfsx(uplo: u8, equed: u8, n: usize, nrhs: usize, a: &[f32], lda: usize, af: &[f32],
    ...
    unsafe {
        ffi::ssyrfsx_(&(uplo as c_char), &(equed as c_char), &(n as c_int), &(nrhs as c_int),
                      ...
                      rcond, berr.as_mut_ptr(), n_err_bnds.as_ptr(), err_bnds_norm.as_mut_ptr(),
                      err_bnds_comp.as_mut_ptr(), nparams.as_ptr(), params.as_mut_ptr(),
                      work.as_mut_ptr(), iwork.as_mut_ptr(), info)
    }
}
...
pub fn csyrfsx(uplo: u8, equed: u8, n: usize, nrhs: usize, a: &[c32], lda: usize, af: &[c32],
    ...
    unsafe {
        ffi::csyrfsx_(&(uplo as c_char), &(equed as c_char), &(n as c_int), &(nrhs as c_int),
                      ...
                      &(ldb as c_int), x.as_mut_ptr() as *mut _, &(ldx as c_int), rcond,
                      berr.as_mut_ptr(), n_err_bnds.as_ptr(), err_bnds_norm.as_mut_ptr(),
                      err_bnds_comp.as_mut_ptr(), nparams.as_ptr(), params.as_mut_ptr(),
                      work.as_mut_ptr() as *mut _, rwork.as_mut_ptr(), info)
    }
...
#[inline]
pub fn sgetri(n: usize, a: &mut [f32], lda: usize, ipiv: &[i32], work: &mut [f32], lwork: isize,
              info: &mut i32) {
...
#[inline]
pub fn dgetri(n: usize, a: &mut [f64], lda: usize, ipiv: &[i32], work: &mut [f64], lwork: isize,
              info: &mut i32) {
...
#[inline]
pub fn cgetri(n: usize, a: &mut [c32], lda: usize, ipiv: &[i32], work: &mut [c32], lwork: isize,
              info: &mut i32) {
...
#[inline]
pub fn zgetri(n: usize, a: &mut [c64], lda: usize, ipiv: &[i32], work: &mut [c64], lwork: isize,
              info: &mut i32) {
...
pub fn sgesvx(fact: u8, trans: u8, n: usize, nrhs: usize, a: &mut [f32], lda: usize,
              ...
              c: &mut [f32], b: &mut [f32], ldb: usize, x: &mut [f32], ldx: usize, rcond: &mut f32,
    ...
    unsafe {
        ffi::sgesvx_(&(fact as c_char), &(trans as c_char), &(n as c_int), &(nrhs as c_int),
                     ...
                     b.as_mut_ptr(), &(ldb as c_int), x.as_mut_ptr(), &(ldx as c_int), rcond,
                     ferr.as_mut_ptr(), berr.as_mut_ptr(), work.as_mut_ptr(), iwork.as_mut_ptr(),
                     info)
    }
}
...
pub fn dgesvx(fact: u8, trans: u8, n: usize, nrhs: usize, a: &mut [f64], lda: usize,
              ...
              c: &mut [f64], b: &mut [f64], ldb: usize, x: &mut [f64], ldx: usize, rcond: &mut f64,
...
pub fn cgesvx(fact: u8, trans: u8, n: usize, nrhs: usize, a: &mut [c32], lda: usize,
              ...
              c: &mut [f32], b: &mut [c32], ldb: usize, x: &mut [c32], ldx: usize, rcond: &mut f32,
    ...
    unsafe {
        ffi::cgesvx_(&(fact as c_char), &(trans as c_char), &(n as c_int), &(nrhs as c_int),
                     ...
                     x.as_mut_ptr() as *mut _, &(ldx as c_int), rcond, ferr.as_mut_ptr(),
                     berr.as_mut_ptr(), work.as_mut_ptr() as *mut _, rwork.as_mut_ptr(), info)
    }
}
...
pub fn zgesvx(fact: u8, trans: u8, n: usize, nrhs: usize, a: &mut [c64], lda: usize,
              ...
              c: &mut [f64], b: &mut [c64], ldb: usize, x: &mut [c64], ldx: usize, rcond: &mut f64,
...
pub fn cgesvxx(fact: u8, trans: u8, n: usize, nrhs: usize, a: &mut [c32], lda: usize,
    ...
    unsafe {
        ffi::cgesvxx_(&(fact as c_char), &(trans as c_char), &(n as c_int), &(nrhs as c_int),
                      ...
                      &(ldaf as c_int), ipiv.as_mut_ptr(), equed as *mut _ as *mut _,
                      r.as_mut_ptr(), c.as_mut_ptr(), b.as_mut_ptr() as *mut _, &(ldb as c_int),
                      x.as_mut_ptr() as *mut _, &(ldx as c_int), rcond, rpvgrw.as_mut_ptr(),
                      berr.as_mut_ptr(), n_err_bnds.as_ptr(), err_bnds_norm.as_mut_ptr(),
                      err_bnds_comp.as_mut_ptr(), nparams.as_ptr(), params.as_mut_ptr(),
                      work.as_mut_ptr() as *mut _, rwork.as_mut_ptr(), info)
    }
...
pub fn sgbsvx(fact: u8, trans: u8, n: usize, kl: usize, ku: usize, nrhs: usize, ab: &mut [f32],
    ...
    unsafe {
        ffi::sgbsvx_(&(fact as c_char), &(trans as c_char), &(n as c_int), &(kl as c_int),
                     ...
                     &(ldb as c_int), x.as_mut_ptr(), &(ldx as c_int), rcond, ferr.as_mut_ptr(),
                     berr.as_mut_ptr(), work.as_mut_ptr(), iwork.as_mut_ptr(), info)
    }
}
...
pub fn cgbsvx(fact: u8, trans: u8, n: usize, kl: usize, ku: usize, nrhs: usize, ab: &mut [c32],
    ...
    unsafe {
        ffi::cgbsvx_(&(fact as c_char), &(trans as c_char), &(n as c_int), &(kl as c_int),
                     ...
                     &(ldx as c_int), rcond, ferr.as_mut_ptr(), berr.as_mut_ptr(),
                     work.as_mut_ptr() as *mut _, rwork.as_mut_ptr(), info)
    }
}
...
pub fn sgbsvxx(fact: u8, trans: u8, n: usize, kl: usize, ku: usize, nrhs: usize, ab: &mut [f32],
    ...
    unsafe {
        ffi::sgbsvxx_(&(fact as c_char), &(trans as c_char), &(n as c_int), &(kl as c_int),
                      ...
                      afb.as_mut_ptr(), &(ldafb as c_int), ipiv.as_mut_ptr(),
                      equed as *mut _ as *mut _, r.as_mut_ptr(), c.as_mut_ptr(), b.as_mut_ptr(),
                      &(ldb as c_int), x.as_mut_ptr(), &(ldx as c_int), rcond, rpvgrw.as_mut_ptr(),
                      berr.as_mut_ptr(), n_err_bnds.as_ptr(), err_bnds_norm.as_mut_ptr(),
                      err_bnds_comp.as_mut_ptr(), nparams.as_ptr(), params.as_mut_ptr(),
                      work.as_mut_ptr(), iwork.as_mut_ptr(), info)
    }
...
pub fn cgbsvxx(fact: u8, trans: u8, n: usize, kl: usize, ku: usize, nrhs: usize, ab: &mut [c32],
    ...
    unsafe {
        ffi::cgbsvxx_(&(fact as c_char), &(trans as c_char), &(n as c_int), &(kl as c_int),
                      ...
                      ipiv.as_mut_ptr(), equed as *mut _ as *mut _, r.as_mut_ptr(), c.as_mut_ptr(),
                      b.as_mut_ptr() as *mut _, &(ldb as c_int), x.as_mut_ptr() as *mut _,
                      &(ldx as c_int), rcond, rpvgrw.as_mut_ptr(), berr.as_mut_ptr(),
                      n_err_bnds.as_ptr(), err_bnds_norm.as_mut_ptr(), err_bnds_comp.as_mut_ptr(),
                      nparams.as_ptr(), params.as_mut_ptr(), work.as_mut_ptr() as *mut _,
                      rwork.as_mut_ptr(), info)
    }
...
pub fn sgtsvx(fact: u8, trans: u8, n: usize, nrhs: usize, dl: &[f32], d: &[f32], du: &[f32],
              ...
              b: &[f32], ldb: usize, x: &mut [f32], ldx: usize, rcond: &mut f32, ferr: &mut [f32],
              berr: &mut [f32], work: &mut [f32], iwork: &mut [i32], info: &mut i32) {
...
pub fn dgtsvx(fact: u8, trans: u8, n: usize, nrhs: usize, dl: &[f64], d: &[f64], du: &[f64],
              ...
              b: &[f64], ldb: usize, x: &mut [f64], ldx: usize, rcond: &mut f64, ferr: &mut [f64],
              berr: &mut [f64], work: &mut [f64], iwork: &mut [i32], info: &mut i32) {
...
pub fn cgtsvx(fact: u8, trans: u8, n: usize, nrhs: usize, dl: &[c32], d: &[c32], du: &[c32],
              ...
              b: &[c32], ldb: usize, x: &mut [c32], ldx: usize, rcond: &mut f32, ferr: &mut [f32],
              berr: &mut [f32], work: &mut [c32], rwork: &mut [f32], info: &mut i32) {
...
pub fn zgtsvx(fact: u8, trans: u8, n: usize, nrhs: usize, dl: &[c64], d: &[c64], du: &[c64],
              ...
              b: &[c64], ldb: usize, x: &mut [c64], ldx: usize, rcond: &mut f64, ferr: &mut [f64],
              berr: &mut [f64], work: &mut [c64], rwork: &mut [f64], info: &mut i32) {
...
pub fn sposvx(fact: u8, uplo: u8, n: usize, nrhs: usize, a: &mut [f32], lda: usize, af: &mut [f32],
    ...
    unsafe {
        ffi::sposvx_(&(fact as c_char), &(uplo as c_char), &(n as c_int), &(nrhs as c_int),
                     ...
                     x.as_mut_ptr(), &(ldx as c_int), rcond, ferr.as_mut_ptr(), berr.as_mut_ptr(),
                     work.as_mut_ptr(), iwork.as_mut_ptr(), info)
    }
}
...
pub fn sposvxx(fact: u8, uplo: u8, n: usize, nrhs: usize, a: &mut [f32], lda: usize,
    ...
    unsafe {
        ffi::sposvxx_(&(fact as c_char), &(uplo as c_char), &(n as c_int), &(nrhs as c_int),
                      a.as_mut_ptr(), &(lda as c_int), af.as_mut_ptr(), &(ldaf as c_int),
                      equed as *mut _ as *mut _, s.as_mut_ptr(), b.as_mut_ptr(), &(ldb as c_int),
                      x.as_mut_ptr(), &(ldx as c_int), rcond, rpvgrw.as_mut_ptr(),
                      berr.as_mut_ptr(), n_err_bnds.as_ptr(), err_bnds_norm.as_mut_ptr(),
                      err_bnds_comp.as_mut_ptr(), nparams.as_ptr(), params.as_mut_ptr(),
                      work.as_mut_ptr(), iwork.as_mut_ptr(), info)
    }
...
pub fn ssysv(uplo: u8, n: usize, nrhs: usize, a: &mut [f32], lda: usize, ipiv: &mut [i32],
             b: &mut [f32], ldb: usize, work: &mut [f32], lwork: isize, info: &mut i32) {
...
pub fn dsysv(uplo: u8, n: usize, nrhs: usize, a: &mut [f64], lda: usize, ipiv: &mut [i32],
             b: &mut [f64], ldb: usize, work: &mut [f64], lwork: isize, info: &mut i32) {
...
pub fn csysv(uplo: u8, n: usize, nrhs: usize, a: &mut [c32], lda: usize, ipiv: &mut [i32],
             b: &mut [c32], ldb: usize, work: &mut [c32], lwork: isize, info: &mut i32) {
...
pub fn zsysv(uplo: u8, n: usize, nrhs: usize, a: &mut [c64], lda: usize, ipiv: &mut [i32],
             b: &mut [c64], ldb: usize, work: &mut [c64], lwork: isize, info: &mut i32) {
...
pub fn ssysvx(fact: u8, uplo: u8, n: usize, nrhs: usize, a: &[f32], lda: usize, af: &mut [f32],
              ...
              rcond: &mut f32, ferr: &mut [f32], berr: &mut [f32], work: &mut [f32], lwork: isize,
              iwork: &mut [i32], info: &mut i32) {
...
pub fn dsysvx(fact: u8, uplo: u8, n: usize, nrhs: usize, a: &[f64], lda: usize, af: &mut [f64],
              ...
              rcond: &mut f64, ferr: &mut [f64], berr: &mut [f64], work: &mut [f64], lwork: isize,
              iwork: &mut [i32], info: &mut i32) {
...
pub fn csysvx(fact: u8, uplo: u8, n: usize, nrhs: usize, a: &[c32], lda: usize, af: &mut [c32],
              ...
              rcond: &mut f32, ferr: &mut [f32], berr: &mut [f32], work: &mut [c32], lwork: isize,
              rwork: &mut [f32], info: &mut i32) {
    ...
    unsafe {
        ffi::csysvx_(&(fact as c_char), &(uplo as c_char), &(n as c_int), &(nrhs as c_int),
                     ...
                     x.as_mut_ptr() as *mut _, &(ldx as c_int), rcond, ferr.as_mut_ptr(),
                     berr.as_mut_ptr(), work.as_mut_ptr() as *mut _, &(lwork as c_int),
                     rwork.as_mut_ptr(), info)
    }
}
...
pub fn zsysvx(fact: u8, uplo: u8, n: usize, nrhs: usize, a: &[c64], lda: usize, af: &mut [c64],
              ...
              rcond: &mut f64, ferr: &mut [f64], berr: &mut [f64], work: &mut [c64], lwork: isize,
              rwork: &mut [f64], info: &mut i32) {
...
pub fn sspsvx(fact: u8, uplo: u8, n: usize, nrhs: usize, ap: &[f32], afp: &mut [f32],
              ipiv: &mut [i32], b: &[f32], ldb: usize, x: &mut [f32], ldx: usize, rcond: &mut f32,
              ferr: &mut [f32], berr: &mut [f32], work: &mut [f32], iwork: &mut [i32],
              info: &mut i32) {
...
pub fn dspsvx(fact: u8, uplo: u8, n: usize, nrhs: usize, ap: &[f64], afp: &mut [f64],
              ipiv: &mut [i32], b: &[f64], ldb: usize, x: &mut [f64], ldx: usize, rcond: &mut f64,
              ferr: &mut [f64], berr: &mut [f64], work: &mut [f64], iwork: &mut [i32],
              info: &mut i32) {
...
pub fn cspsvx(fact: u8, uplo: u8, n: usize, nrhs: usize, ap: &[c32], afp: &mut [c32],
              ipiv: &mut [i32], b: &[c32], ldb: usize, x: &mut [c32], ldx: usize, rcond: &mut f32,
              ferr: &mut [f32], berr: &mut [f32], work: &mut [c32], rwork: &mut [f32],
              info: &mut i32) {
...
pub fn zspsvx(fact: u8, uplo: u8, n: usize, nrhs: usize, ap: &[c64], afp: &mut [c64],
              ipiv: &mut [i32], b: &[c64], ldb: usize, x: &mut [c64], ldx: usize, rcond: &mut f64,
              ferr: &mut [f64], berr: &mut [f64], work: &mut [c64], rwork: &mut [f64],
              info: &mut i32) {
...
pub fn sgeqp3(m: usize, n: usize, a: &mut [f32], lda: usize, jpvt: &mut [i32], tau: &mut [f32],
              work: &mut [f32], lwork: isize, info: &mut i32) {
...
pub fn dgeqp3(m: usize, n: usize, a: &mut [f64], lda: usize, jpvt: &mut [i32], tau: &mut [f64],
              work: &mut [f64], lwork: isize, info: &mut i32) {
...
pub fn cgeqp3(m: usize, n: usize, a: &mut [c32], lda: usize, jpvt: &mut [i32], tau: &mut [c32],
              work: &mut [c32], lwork: isize, rwork: &mut [f32], info: &mut i32) {
...
pub fn zgeqp3(m: usize, n: usize, a: &mut [c64], lda: usize, jpvt: &mut [i32], tau: &mut [c64],
              work: &mut [c64], lwork: isize, rwork: &mut [f64], info: &mut i32) {
...
pub fn sormqr(side: u8, trans: u8, m: usize, n: usize, k: usize, a: &[f32], lda: usize,
              tau: &[f32], c: &mut [f32], ldc: usize, work: &mut [f32], lwork: isize,
              info: &mut i32) {
...
pub fn dormqr(side: u8, trans: u8, m: usize, n: usize, k: usize, a: &[f64], lda: usize,
              tau: &[f64], c: &mut [f64], ldc: usize, work: &mut [f64], lwork: isize,
              info: &mut i32) {
...
pub fn cungqr(m: usize, n: usize, k: usize, a: &mut [c32], lda: usize, tau: &[c32],
              work: &mut [c32], lwork: isize, info: &mut i32) {
...
pub fn zungqr(m: usize, n: usize, k: usize, a: &mut [c64], lda: usize, tau: &[c64],
              work: &mut [c64], lwork: isize, info: &mut i32) {
...
pub fn cunmqr(side: u8, trans: u8, m: usize, n: usize, k: usize, a: &[c32], lda: usize,
              tau: &[c32], c: &mut [c32], ldc: usize, work: &mut [c32], lwork: isize,
              info: &mut i32) {
...
pub fn zunmqr(side: u8, trans: u8, m: usize, n: usize, k: usize, a: &[c64], lda: usize,
              tau: &[c64], c: &mut [c64], ldc: usize, work: &mut [c64], lwork: isize,
              info: &mut i32) {
...
#[inline]
pub fn sormrz(side: u8, trans: u8, m: usize, n: usize, k: usize, l: usize, a: &[f32], lda: usize,
              tau: &[f32], c: &mut [f32], ldc: usize, work: &mut [f32], lwork: isize,
              info: &mut i32) {

    unsafe {
        ffi::sormrz_(&(side as c_char), &(trans as c_char), &(m as c_int), &(n as c_int),
                     &(k as c_int), &(l as c_int), a.as_ptr(), &(lda as c_int), tau.as_ptr(),
                     c.as_mut_ptr(), &(ldc as c_int), work.as_mut_ptr(), &(lwork as c_int), info)
    }
}

#[inline]
pub fn dormrz(side: u8, trans: u8, m: usize, n: usize, k: usize, l: usize, a: &[f64], lda: usize,
              tau: &[f64], c: &mut [f64], ldc: usize, work: &mut [f64], lwork: isize,
              info: &mut i32) {
...
#[inline]
pub fn cunmrz(side: u8, trans: u8, m: usize, n: usize, k: usize, l: usize, a: &[c32], lda: usize,
              tau: &[c32], c: &mut [c32], ldc: usize, work: &mut [c32], lwork: isize,
              info: &mut i32) {

    unsafe {
        ffi::cunmrz_(&(side as c_char), &(trans as c_char), &(m as c_int), &(n as c_int),
                     &(k as c_int), &(l as c_int), a.as_ptr() as *const _, &(lda as c_int),
                     tau.as_ptr() as *const _, c.as_mut_ptr() as *mut _, &(ldc as c_int),
                     work.as_mut_ptr() as *mut _, &(lwork as c_int), info)
    }
}
...
#[inline]
pub fn zunmrz(side: u8, trans: u8, m: usize, n: usize, k: usize, l: usize, a: &[c64], lda: usize,
              tau: &[c64], c: &mut [c64], ldc: usize, work: &mut [c64], lwork: isize,
              info: &mut i32) {
...
#[inline]
pub fn sggqrf(n: usize, m: usize, p: usize, a: &mut [f32], lda: usize, taua: &mut [f32],
              b: &mut [f32], ldb: usize, taub: &mut [f32], work: &mut [f32], lwork: isize,
              info: &mut i32) {

    unsafe {
        ffi::sggqrf_(&(n as c_int), &(m as c_int), &(p as c_int), a.as_mut_ptr(), &(lda as c_int),
...
#[inline]
pub fn dggqrf(n: usize, m: usize, p: usize, a: &mut [f64], lda: usize, taua: &mut [f64],
              b: &mut [f64], ldb: usize, taub: &mut [f64], work: &mut [f64], lwork: isize,
              info: &mut i32) {

    unsafe {
        ffi::dggqrf_(&(n as c_int), &(m as c_int), &(p as c_int), a.as_mut_ptr(), &(lda as c_int),
                     taua.as_mut_ptr(), b.as_mut_ptr(), &(ldb as c_int), taub.as_mut_ptr(),
                     work.as_mut_ptr(), &(lwork as c_int), info)
    }
}
...
#[inline]
pub fn cggqrf(n: usize, m: usize, p: usize, a: &mut [c32], lda: usize, taua: &mut [c32],
              b: &mut [c32], ldb: usize, taub: &mut [c32], work: &mut [c32], lwork: isize,
              info: &mut i32) {

    unsafe {
        ffi::cggqrf_(&(n as c_int), &(m as c_int), &(p as c_int), a.as_mut_ptr() as *mut _,
...
#[inline]
pub fn zggqrf(n: usize, m: usize, p: usize, a: &mut [c64], lda: usize, taua: &mut [c64],
              b: &mut [c64], ldb: usize, taub: &mut [c64], work: &mut [c64], lwork: isize,
              info: &mut i32) {

    unsafe {
        ffi::zggqrf_(&(n as c_int), &(m as c_int), &(p as c_int), a.as_mut_ptr() as *mut _,
                     &(lda as c_int), taua.as_mut_ptr() as *mut _, b.as_mut_ptr() as *mut _,
                     &(ldb as c_int), taub.as_mut_ptr() as *mut _, work.as_mut_ptr() as *mut _,
                     &(lwork as c_int), info)
    }
...
#[inline]
pub fn sggrqf(m: usize, p: usize, n: usize, a: &mut [f32], lda: usize, taua: &mut [f32],
              b: &mut [f32], ldb: usize, taub: &mut [f32], work: &mut [f32], lwork: isize,
              info: &mut i32) {

    unsafe {
        ffi::sggrqf_(&(m as c_int), &(p as c_int), &(n as c_int), a.as_mut_ptr(), &(lda as c_int),
                     taua.as_mut_ptr(), b.as_mut_ptr(), &(ldb as c_int), taub.as_mut_ptr(),
                     work.as_mut_ptr(), &(lwork as c_int), info)
    }
}
...
#[inline]
pub fn dggrqf(m: usize, p: usize, n: usize, a: &mut [f64], lda: usize, taua: &mut [f64],
              b: &mut [f64], ldb: usize, taub: &mut [f64], work: &mut [f64], lwork: isize,
              info: &mut i32) {

    unsafe {
        ffi::dggrqf_(&(m as c_int), &(p as c_int), &(n as c_int), a.as_mut_ptr(), &(lda as c_int),
                     taua.as_mut_ptr(), b.as_mut_ptr(), &(ldb as c_int), taub.as_mut_ptr(),
                     work.as_mut_ptr(), &(lwork as c_int), info)
    }
}
...
#[inline]
pub fn cggrqf(m: usize, p: usize, n: usize, a: &mut [c32], lda: usize, taua: &mut [c32],
              b: &mut [c32], ldb: usize, taub: &mut [c32], work: &mut [c32], lwork: isize,
              info: &mut i32) {

    unsafe {
        ffi::cggrqf_(&(m as c_int), &(p as c_int), &(n as c_int), a.as_mut_ptr() as *mut _,
                     &(lda as c_int), taua.as_mut_ptr() as *mut _, b.as_mut_ptr() as *mut _,
                     &(ldb as c_int), taub.as_mut_ptr() as *mut _, work.as_mut_ptr() as *mut _,
                     &(lwork as c_int), info)
    }
...
#[inline]
pub fn zggrqf(m: usize, p: usize, n: usize, a: &mut [c64], lda: usize, taua: &mut [c64],
              b: &mut [c64], ldb: usize, taub: &mut [c64], work: &mut [c64], lwork: isize,
              info: &mut i32) {

    unsafe {
        ffi::zggrqf_(&(m as c_int), &(p as c_int), &(n as c_int), a.as_mut_ptr() as *mut _,
                     &(lda as c_int), taua.as_mut_ptr() as *mut _, b.as_mut_ptr() as *mut _,
                     &(ldb as c_int), taub.as_mut_ptr() as *mut _, work.as_mut_ptr() as *mut _,
                     &(lwork as c_int), info)
    }
...
pub fn sgebrd(m: usize, n: usize, a: &mut [f32], lda: usize, d: &mut [f32], e: &mut [f32],
              tauq: &mut [f32], taup: &mut [f32], work: &mut [f32], lwork: isize, info: &mut i32) {
...
pub fn dgebrd(m: usize, n: usize, a: &mut [f64], lda: usize, d: &mut [f64], e: &mut [f64],
              tauq: &mut [f64], taup: &mut [f64], work: &mut [f64], lwork: isize, info: &mut i32) {
...
pub fn cgebrd(m: usize, n: usize, a: &mut [c32], lda: usize, d: &mut [f32], e: &mut [f32],
              tauq: &mut [c32], taup: &mut [c32], work: &mut [c32], lwork: isize, info: &mut i32) {
...
pub fn zgebrd(m: usize, n: usize, a: &mut [c64], lda: usize, d: &mut [f64], e: &mut [f64],
              tauq: &mut [c64], taup: &mut [c64], work: &mut [c64], lwork: isize, info: &mut i32) {
...
pub fn ssytrd(uplo: u8, n: usize, a: &mut [f32], lda: usize, d: &mut [f32], e: &mut [f32],
              tau: &mut [f32], work: &mut [f32], lwork: isize, info: &mut i32) {
...
pub fn dsytrd(uplo: u8, n: usize, a: &mut [f64], lda: usize, d: &mut [f64], e: &mut [f64],
              tau: &mut [f64], work: &mut [f64], lwork: isize, info: &mut i32) {
...
pub fn chetrd(uplo: u8, n: usize, a: &mut [c32], lda: usize, d: &mut [f32], e: &mut [f32],
              tau: &mut [c32], work: &mut [c32], lwork: isize, info: &mut i32) {
...
pub fn zhetrd(uplo: u8, n: usize, a: &mut [c64], lda: usize, d: &mut [f64], e: &mut [f64],
              tau: &mut [c64], work: &mut [c64], lwork: isize, info: &mut i32) {
...
pub fn sormhr(side: u8, trans: u8, m: usize, n: usize, ilo: &[i32], ihi: &[i32], a: &[f32],
              lda: usize, tau: &[f32], c: &mut [f32], ldc: usize, work: &mut [f32], lwork: isize,
              info: &mut i32) {
...
pub fn dormhr(side: u8, trans: u8, m: usize, n: usize, ilo: &[i32], ihi: &[i32], a: &[f64],
              lda: usize, tau: &[f64], c: &mut [f64], ldc: usize, work: &mut [f64], lwork: isize,
              info: &mut i32) {
...
pub fn cunmhr(side: u8, trans: u8, m: usize, n: usize, ilo: &[i32], ihi: &[i32], a: &[c32],
              lda: usize, tau: &[c32], c: &mut [c32], ldc: usize, work: &mut [c32], lwork: isize,
              info: &mut i32) {
...
pub fn zunmhr(side: u8, trans: u8, m: usize, n: usize, ilo: &[i32], ihi: &[i32], a: &[c64],
              lda: usize, tau: &[c64], c: &mut [c64], ldc: usize, work: &mut [c64], lwork: isize,
              info: &mut i32) {
...
pub fn chseqr(job: u8, compz: u8, n: usize, ilo: &[i32], ihi: &[i32], h: &mut [c32], ldh: usize,
              w: &mut [c32], z: &mut [c32], ldz: usize, work: &mut [c32], lwork: isize,
              info: &mut i32) {
...
pub fn zhseqr(job: u8, compz: u8, n: usize, ilo: &[i32], ihi: &[i32], h: &mut [c64], ldh: usize,
              w: &mut [c64], z: &mut [c64], ldz: usize, work: &mut [c64], lwork: isize,
              info: &mut i32) {
...
pub fn ctrsen(job: u8, compq: u8, select: &[i32], n: usize, t: &mut [c32], ldt: usize,
              ...
              sep: &mut [f32], work: &mut [c32], lwork: isize, info: &mut i32) {
...
pub fn ztrsen(job: u8, compq: u8, select: &[i32], n: usize, t: &mut [c64], ldt: usize,
              ...
              sep: &mut [f64], work: &mut [c64], lwork: isize, info: &mut i32) {
...
pub fn chgeqz(job: u8, compq: u8, compz: u8, n: usize, ilo: &[i32], ihi: &[i32], h: &mut [c32],
              ...
              q: &mut [c32], ldq: usize, z: &mut [c32], ldz: usize, work: &mut [c32], lwork: isize,
              rwork: &mut [f32], info: &mut i32) {
...
pub fn zhgeqz(job: u8, compq: u8, compz: u8, n: usize, ilo: &[i32], ihi: &[i32], h: &mut [c64],
              ...
              q: &mut [c64], ldq: usize, z: &mut [c64], ldz: usize, work: &mut [c64], lwork: isize,
              rwork: &mut [f64], info: &mut i32) {
...
pub fn stgexc(wantq: &[i32], wantz: &[i32], n: usize, a: &mut [f32], lda: usize, b: &mut [f32],
              ...
              ilst: &mut [i32], work: &mut [f32], lwork: isize, info: &mut i32) {
...
pub fn dtgexc(wantq: &[i32], wantz: &[i32], n: usize, a: &mut [f64], lda: usize, b: &mut [f64],
              ...
              ilst: &mut [i32], work: &mut [f64], lwork: isize, info: &mut i32) {
...
pub fn stgsyl(trans: u8, ijob: &[i32], m: usize, n: usize, a: &[f32], lda: usize, b: &[f32],
              ...
              lwork: isize, iwork: &mut [i32], info: &mut i32) {
...
pub fn stgsna(job: u8, howmny: u8, select: &[i32], n: usize, a: &[f32], lda: usize, b: &[f32],
              ...
              dif: &mut [f32], mm: usize, m: &mut u32, work: &mut [f32], lwork: isize,
              iwork: &mut [i32], info: &mut i32) {
...
pub fn dtgsna(job: u8, howmny: u8, select: &[i32], n: usize, a: &[f64], lda: usize, b: &[f64],
              ...
              dif: &mut [f64], mm: usize, m: &mut u32, work: &mut [f64], lwork: isize,
              iwork: &mut [i32], info: &mut i32) {
...
pub fn ctgsna(job: u8, howmny: u8, select: &[i32], n: usize, a: &[c32], lda: usize, b: &[c32],
              ...
              dif: &mut [f32], mm: usize, m: &mut u32, work: &mut [c32], lwork: isize,
              iwork: &mut [i32], info: &mut i32) {
...
pub fn ztgsna(job: u8, howmny: u8, select: &[i32], n: usize, a: &[c64], lda: usize, b: &[c64],
              ...
              dif: &mut [f64], mm: usize, m: &mut u32, work: &mut [c64], lwork: isize,
              iwork: &mut [i32], info: &mut i32) {
...
#[inline]
pub fn sggsvp(jobu: u8, jobv: u8, jobq: u8, m: usize, p: usize, n: usize, a: &mut [f32],
              lda: usize, b: &mut [f32], ldb: usize, tola: &[f32], tolb: &[f32], k: &mut u32,
              l: &mut u32, u: &mut [f32], ldu: usize, v: &mut [f32], ldv: usize, q: &mut [f32],
    ...
    unsafe {
        ffi::sggsvp_(&(jobu as c_char), &(jobv as c_char), &(jobq as c_char), &(m as c_int),
                     &(p as c_int), &(n as c_int), a.as_mut_ptr(), &(lda as c_int), b.as_mut_ptr(),
                     &(ldb as c_int), tola.as_ptr(), tolb.as_ptr(), k as *mut _ as *mut _,
                     l as *mut _ as *mut _, u.as_mut_ptr(), &(ldu as c_int), v.as_mut_ptr(),
...
#[inline]
pub fn dggsvp(jobu: u8, jobv: u8, jobq: u8, m: usize, p: usize, n: usize, a: &mut [f64],
              lda: usize, b: &mut [f64], ldb: usize, tola: &[f64], tolb: &[f64], k: &mut u32,
              l: &mut u32, u: &mut [f64], ldu: usize, v: &mut [f64], ldv: usize, q: &mut [f64],
...
#[inline]
pub fn cggsvp(jobu: u8, jobv: u8, jobq: u8, m: usize, p: usize, n: usize, a: &mut [c32],
              lda: usize, b: &mut [c32], ldb: usize, tola: &[f32], tolb: &[f32], k: &mut u32,
              l: &mut u32, u: &mut [c32], ldu: usize, v: &mut [c32], ldv: usize, q: &mut [c32],
    ...
    unsafe {
        ffi::cggsvp_(&(jobu as c_char), &(jobv as c_char), &(jobq as c_char), &(m as c_int),
                     &(p as c_int), &(n as c_int), a.as_mut_ptr() as *mut _, &(lda as c_int),
                     b.as_mut_ptr() as *mut _, &(ldb as c_int), tola.as_ptr(), tolb.as_ptr(),
                     k as *mut _ as *mut _, l as *mut _ as *mut _, u.as_mut_ptr() as *mut _,
...
#[inline]
pub fn zggsvp(jobu: u8, jobv: u8, jobq: u8, m: usize, p: usize, n: usize, a: &mut [c64],
              lda: usize, b: &mut [c64], ldb: usize, tola: &[f64], tolb: &[f64], k: &mut u32,
              l: &mut u32, u: &mut [c64], ldu: usize, v: &mut [c64], ldv: usize, q: &mut [c64],
...
#[inline]
pub fn stgsja(jobu: u8, jobv: u8, jobq: u8, m: usize, p: usize, n: usize, k: usize, l: usize,
    ...
    unsafe {
        ffi::stgsja_(&(jobu as c_char), &(jobv as c_char), &(jobq as c_char), &(m as c_int),
                     &(p as c_int), &(n as c_int), &(k as c_int), &(l as c_int), a.as_mut_ptr(),
...
#[inline]
pub fn dtgsja(jobu: u8, jobv: u8, jobq: u8, m: usize, p: usize, n: usize, k: usize, l: usize,
...
#[inline]
pub fn ctgsja(jobu: u8, jobv: u8, jobq: u8, m: usize, p: usize, n: usize, k: usize, l: usize,
    ...
    unsafe {
        ffi::ctgsja_(&(jobu as c_char), &(jobv as c_char), &(jobq as c_char), &(m as c_int),
                     &(p as c_int), &(n as c_int), &(k as c_int), &(l as c_int),
                     a.as_mut_ptr() as *mut _, &(lda as c_int), b.as_mut_ptr() as *mut _,
...
#[inline]
pub fn ztgsja(jobu: u8, jobv: u8, jobq: u8, m: usize, p: usize, n: usize, k: usize, l: usize,
...
pub fn sgels(trans: u8, m: usize, n: usize, nrhs: usize, a: &mut [f32], lda: usize, b: &mut [f32],
             ldb: usize, work: &mut [f32], lwork: isize, info: &mut i32) {
...
pub fn dgels(trans: u8, m: usize, n: usize, nrhs: usize, a: &mut [f64], lda: usize, b: &mut [f64],
             ldb: usize, work: &mut [f64], lwork: isize, info: &mut i32) {
...
pub fn cgels(trans: u8, m: usize, n: usize, nrhs: usize, a: &mut [c32], lda: usize, b: &mut [c32],
             ldb: usize, work: &mut [c32], lwork: isize, info: &mut i32) {
...
pub fn zgels(trans: u8, m: usize, n: usize, nrhs: usize, a: &mut [c64], lda: usize, b: &mut [c64],
             ldb: usize, work: &mut [c64], lwork: isize, info: &mut i32) {
...
pub fn sgelsy(m: usize, n: usize, nrhs: usize, a: &mut [f32], lda: usize, b: &mut [f32],
    ...
    unsafe {
        ffi::sgelsy_(&(m as c_int), &(n as c_int), &(nrhs as c_int), a.as_mut_ptr(),
                     &(lda as c_int), b.as_mut_ptr(), &(ldb as c_int), jpvt.as_mut_ptr(), &rcond,
                     rank as *mut _ as *mut _, work.as_mut_ptr(), &(lwork as c_int), info)
    }
}
...
pub fn cgelsy(m: usize, n: usize, nrhs: usize, a: &mut [c32], lda: usize, b: &mut [c32],
              ...
              lwork: isize, rwork: &mut [f32], info: &mut i32) {
    ...
    unsafe {
        ffi::cgelsy_(&(m as c_int), &(n as c_int), &(nrhs as c_int), a.as_mut_ptr() as *mut _,
                     ...
                     &rcond, rank as *mut _ as *mut _, work.as_mut_ptr() as *mut _,
                     &(lwork as c_int), rwork.as_mut_ptr(), info)
    }
}
...
pub fn zgelsy(m: usize, n: usize, nrhs: usize, a: &mut [c64], lda: usize, b: &mut [c64],
              ...
              lwork: isize, rwork: &mut [f64], info: &mut i32) {
...
pub fn sgelss(m: usize, n: usize, nrhs: usize, a: &mut [f32], lda: usize, b: &mut [f32],
    ...
    unsafe {
        ffi::sgelss_(&(m as c_int), &(n as c_int), &(nrhs as c_int), a.as_mut_ptr(),
                     &(lda as c_int), b.as_mut_ptr(), &(ldb as c_int), s.as_mut_ptr(), &rcond,
                     rank as *mut _ as *mut _, work.as_mut_ptr(), &(lwork as c_int), info)
    }
}
...
pub fn sgelsd(m: usize, n: usize, nrhs: usize, a: &[f32], lda: usize, b: &mut [f32], ldb: usize,
              s: &mut [f32], rcond: f32, rank: &mut u32, work: &mut [f32], lwork: isize,
              iwork: &mut [i32], info: &mut i32) {

    unsafe {
        ffi::sgelsd_(&(m as c_int), &(n as c_int), &(nrhs as c_int), a.as_ptr(), &(lda as c_int),
                     b.as_mut_ptr(), &(ldb as c_int), s.as_mut_ptr(), &rcond,
...
pub fn dgelsd(m: usize, n: usize, nrhs: usize, a: &[f64], lda: usize, b: &mut [f64], ldb: usize,
              s: &mut [f64], rcond: f64, rank: &mut u32, work: &mut [f64], lwork: isize,
              iwork: &mut [i32], info: &mut i32) {
...
pub fn cgelsd(m: usize, n: usize, nrhs: usize, a: &mut [c32], lda: usize, b: &mut [c32],
              ldb: usize, s: &mut [f32], rcond: f32, rank: &mut u32, work: &mut [c32],
              lwork: isize, rwork: &mut [f32], iwork: &mut [i32], info: &mut i32) {
...
pub fn zgelsd(m: usize, n: usize, nrhs: usize, a: &[c64], lda: usize, b: &mut [c64], ldb: usize,
              s: &mut [f64], rcond: f64, rank: &mut u32, work: &mut [c64], lwork: isize,
...
#[inline]
pub fn sgglse(m: usize, n: usize, p: usize, a: &mut [f32], lda: usize, b: &mut [f32], ldb: usize,
              c: &mut [f32], d: &mut [f32], x: &mut [f32], work: &mut [f32], lwork: isize,
              info: &mut i32) {

    unsafe {
        ffi::sgglse_(&(m as c_int), &(n as c_int), &(p as c_int), a.as_mut_ptr(), &(lda as c_int),
...
#[inline]
pub fn dgglse(m: usize, n: usize, p: usize, a: &mut [f64], lda: usize, b: &mut [f64], ldb: usize,
              c: &mut [f64], d: &mut [f64], x: &mut [f64], work: &mut [f64], lwork: isize,
              info: &mut i32) {

    unsafe {
        ffi::dgglse_(&(m as c_int), &(n as c_int), &(p as c_int), a.as_mut_ptr(), &(lda as c_int),
                     b.as_mut_ptr(), &(ldb as c_int), c.as_mut_ptr(), d.as_mut_ptr(),
                     x.as_mut_ptr(), work.as_mut_ptr(), &(lwork as c_int), info)
    }
}
...
#[inline]
pub fn cgglse(m: usize, n: usize, p: usize, a: &mut [c32], lda: usize, b: &mut [c32], ldb: usize,
              c: &mut [c32], d: &mut [c32], x: &mut [c32], work: &mut [c32], lwork: isize,
              info: &mut i32) {

    unsafe {
        ffi::cgglse_(&(m as c_int), &(n as c_int), &(p as c_int), a.as_mut_ptr() as *mut _,
                     &(lda as c_int), b.as_mut_ptr() as *mut _, &(ldb as c_int),
...
#[inline]
pub fn zgglse(m: usize, n: usize, p: usize, a: &mut [c64], lda: usize, b: &mut [c64], ldb: usize,
              c: &mut [c64], d: &mut [c64], x: &mut [c64], work: &mut [c64], lwork: isize,
              info: &mut i32) {

    unsafe {
        ffi::zgglse_(&(m as c_int), &(n as c_int), &(p as c_int), a.as_mut_ptr() as *mut _,
                     &(lda as c_int), b.as_mut_ptr() as *mut _, &(ldb as c_int),
                     c.as_mut_ptr() as *mut _, d.as_mut_ptr() as *mut _, x.as_mut_ptr() as *mut _,
                     work.as_mut_ptr() as *mut _, &(lwork as c_int), info)
    }
...
#[inline]
pub fn sggglm(n: usize, m: usize, p: usize, a: &mut [f32], lda: usize, b: &mut [f32], ldb: usize,
              d: &mut [f32], x: &mut [f32], y: &mut [f32], work: &mut [f32], lwork: isize,
              info: &mut i32) {

    unsafe {
        ffi::sggglm_(&(n as c_int), &(m as c_int), &(p as c_int), a.as_mut_ptr(), &(lda as c_int),
...
#[inline]
pub fn dggglm(n: usize, m: usize, p: usize, a: &mut [f64], lda: usize, b: &mut [f64], ldb: usize,
              d: &mut [f64], x: &mut [f64], y: &mut [f64], work: &mut [f64], lwork: isize,
              info: &mut i32) {

    unsafe {
        ffi::dggglm_(&(n as c_int), &(m as c_int), &(p as c_int), a.as_mut_ptr(), &(lda as c_int),
                     b.as_mut_ptr(), &(ldb as c_int), d.as_mut_ptr(), x.as_mut_ptr(),
                     y.as_mut_ptr(), work.as_mut_ptr(), &(lwork as c_int), info)
    }
}
...
#[inline]
pub fn cggglm(n: usize, m: usize, p: usize, a: &mut [c32], lda: usize, b: &mut [c32], ldb: usize,
              d: &mut [c32], x: &mut [c32], y: &mut [c32], work: &mut [c32], lwork: isize,
              info: &mut i32) {

    unsafe {
        ffi::cggglm_(&(n as c_int), &(m as c_int), &(p as c_int), a.as_mut_ptr() as *mut _,
                     &(lda as c_int), b.as_mut_ptr() as *mut _, &(ldb as c_int),
...
#[inline]
pub fn zggglm(n: usize, m: usize, p: usize, a: &mut [c64], lda: usize, b: &mut [c64], ldb: usize,
              d: &mut [c64], x: &mut [c64], y: &mut [c64], work: &mut [c64], lwork: isize,
              info: &mut i32) {

    unsafe {
        ffi::zggglm_(&(n as c_int), &(m as c_int), &(p as c_int), a.as_mut_ptr() as *mut _,
                     &(lda as c_int), b.as_mut_ptr() as *mut _, &(ldb as c_int),
                     d.as_mut_ptr() as *mut _, x.as_mut_ptr() as *mut _, y.as_mut_ptr() as *mut _,
                     work.as_mut_ptr() as *mut _, &(lwork as c_int), info)
    }
...
pub fn sgees(jobvs: u8, sort: u8, select: Select2F32, n: usize, a: &mut [f32], lda: usize,
             ...
             work: &mut [f32], lwork: isize, bwork: &mut [i32], info: &mut i32) {
...
pub fn dgees(jobvs: u8, sort: u8, select: Select2F64, n: usize, a: &mut [f64], lda: usize,
             ...
             work: &mut [f64], lwork: isize, bwork: &mut [i32], info: &mut i32) {
...
pub fn cgees(jobvs: u8, sort: u8, select: Select1C32, n: usize, a: &mut [c32], lda: usize,
             ...
             lwork: isize, rwork: &mut [f32], bwork: &mut [i32], info: &mut i32) {
...
pub fn zgees(jobvs: u8, sort: u8, select: Select1C64, n: usize, a: &mut [c64], lda: usize,
             ...
             lwork: isize, rwork: &mut [f64], bwork: &mut [i32], info: &mut i32) {
...
pub fn cgeesx(jobvs: u8, sort: u8, select: Select1C32, sense: u8, n: usize, a: &mut [c32],
              ...
              rconde: &mut [f32], rcondv: &mut [f32], work: &mut [c32], lwork: isize,
...
pub fn zgeesx(jobvs: u8, sort: u8, select: Select1C64, sense: u8, n: usize, a: &mut [c64],
              ...
              rconde: &mut [f64], rcondv: &mut [f64], work: &mut [c64], lwork: isize,
...
pub fn sgeevx(balanc: u8, jobvl: u8, jobvr: u8, sense: u8, n: usize, a: &mut [f32], lda: usize,
              ...
              rconde: &mut [f32], rcondv: &mut [f32], work: &mut [f32], lwork: isize,
              iwork: &mut [i32], info: &mut i32) {
...
pub fn dgeevx(balanc: u8, jobvl: u8, jobvr: u8, sense: u8, n: usize, a: &mut [f64], lda: usize,
              ...
              rconde: &mut [f64], rcondv: &mut [f64], work: &mut [f64], lwork: isize,
              iwork: &mut [i32], info: &mut i32) {
...
pub fn zgesdd(jobz: u8, m: usize, n: usize, a: &mut [c64], lda: usize, s: &mut [f64],
              u: &mut [c64], ldu: usize, vt: &mut [c64], ldvt: usize, work: &mut [c64],
              lwork: isize, rwork: &mut [f64], iwork: &mut [i32], info: &mut i32) {
...
pub fn dgejsv(joba: &mut u8, jobu: &mut u8, jobv: &mut u8, jobr: &mut u8, jobt: &mut u8,
              ...
              u: &mut [f64], ldu: usize, v: &mut [f64], ldv: usize, work: &mut [f64], lwork: isize,
              iwork: &mut [i32], info: &mut i32) {
...
pub fn sgejsv(joba: &mut u8, jobu: &mut u8, jobv: &mut u8, jobr: &mut u8, jobt: &mut u8,
              ...
              u: &mut [f32], ldu: usize, v: &mut [f32], ldv: usize, work: &mut [f32], lwork: isize,
              iwork: &mut [i32], info: &mut i32) {
...
#[inline]
pub fn sggsvd(jobu: u8, jobv: u8, jobq: u8, m: usize, n: usize, p: usize, k: &mut u32, l: &mut u32,
              a: &mut [f32], lda: usize, b: &mut [f32], ldb: usize, alpha: &mut [f32],
              beta: &mut [f32], u: &mut [f32], ldu: usize, v: &mut [f32], ldv: usize,
              q: &mut [f32], ldq: usize, work: &mut [f32], iwork: &mut [i32], info: &mut i32) {

    unsafe {
        ffi::sggsvd_(&(jobu as c_char), &(jobv as c_char), &(jobq as c_char), &(m as c_int),
                     &(n as c_int), &(p as c_int), k as *mut _ as *mut _, l as *mut _ as *mut _,
                     a.as_mut_ptr(), &(lda as c_int), b.as_mut_ptr(), &(ldb as c_int),
...
#[inline]
pub fn dggsvd(jobu: u8, jobv: u8, jobq: u8, m: usize, n: usize, p: usize, k: &mut u32, l: &mut u32,
              a: &mut [f64], lda: usize, b: &mut [f64], ldb: usize, alpha: &mut [f64],
              beta: &mut [f64], u: &mut [f64], ldu: usize, v: &mut [f64], ldv: usize,
              q: &mut [f64], ldq: usize, work: &mut [f64], iwork: &mut [i32], info: &mut i32) {
...
#[inline]
pub fn cggsvd(jobu: u8, jobv: u8, jobq: u8, m: usize, n: usize, p: usize, k: &mut u32, l: &mut u32,
              a: &mut [c32], lda: usize, b: &mut [c32], ldb: usize, alpha: &mut [f32],
              beta: &mut [f32], u: &mut [c32], ldu: usize, v: &mut [c32], ldv: usize,
              q: &mut [c32], ldq: usize, work: &mut [c32], rwork: &mut [f32], iwork: &mut [i32],
              info: &mut i32) {
...
#[inline]
pub fn zggsvd(jobu: u8, jobv: u8, jobq: u8, m: usize, n: usize, p: usize, k: &mut u32, l: &mut u32,
              a: &mut [c64], lda: usize, b: &mut [c64], ldb: usize, alpha: &mut [f64],
              beta: &mut [f64], u: &mut [c64], ldu: usize, v: &mut [c64], ldv: usize,
              q: &mut [c64], ldq: usize, work: &mut [c64], rwork: &mut [f64], iwork: &mut [i32],
              info: &mut i32) {
...
pub fn ssygv(itype: &[i32], jobz: u8, uplo: u8, n: usize, a: &mut [f32], lda: usize, b: &mut [f32],
             ldb: usize, w: &mut [f32], work: &mut [f32], lwork: isize, info: &mut i32) {
...
pub fn dsygv(itype: &[i32], jobz: u8, uplo: u8, n: usize, a: &mut [f64], lda: usize, b: &mut [f64],
             ldb: usize, w: &mut [f64], work: &mut [f64], lwork: isize, info: &mut i32) {
...
pub fn chegv(itype: &[i32], jobz: u8, uplo: u8, n: usize, a: &mut [c32], lda: usize, b: &mut [c32],
             ldb: usize, w: &mut [f32], work: &mut [c32], lwork: isize, rwork: &mut [f32],
             info: &mut i32) {
...
pub fn zhegv(itype: &[i32], jobz: u8, uplo: u8, n: usize, a: &mut [c64], lda: usize, b: &mut [c64],
             ldb: usize, w: &mut [f64], work: &mut [c64], lwork: isize, rwork: &mut [f64],
             info: &mut i32) {
...
pub fn ssygvx(itype: &[i32], jobz: u8, range: u8, uplo: u8, n: usize, a: &mut [f32], lda: usize,
              ...
              abstol: &[f32], m: &mut u32, w: &mut [f32], z: &mut [f32], ldz: usize,
              work: &mut [f32], lwork: isize, iwork: &mut [i32], ifail: &mut [i32],
              info: &mut i32) {
...
pub fn dsygvx(itype: &[i32], jobz: u8, range: u8, uplo: u8, n: usize, a: &mut [f64], lda: usize,
              ...
              abstol: &[f64], m: &mut u32, w: &mut [f64], z: &mut [f64], ldz: usize,
              work: &mut [f64], lwork: isize, iwork: &mut [i32], ifail: &mut [i32],
              info: &mut i32) {
...
pub fn chegvx(itype: &[i32], jobz: u8, range: u8, uplo: u8, n: usize, a: &mut [c32], lda: usize,
              ...
              abstol: &[f32], m: &mut u32, w: &mut [f32], z: &mut [c32], ldz: usize,
              work: &mut [c32], lwork: isize, rwork: &mut [f32], iwork: &mut [i32],
              ifail: &mut [i32], info: &mut i32) {
...
pub fn zhegvx(itype: &[i32], jobz: u8, range: u8, uplo: u8, n: usize, a: &mut [c64], lda: usize,
              ...
              abstol: &[f64], m: &mut u32, w: &mut [f64], z: &mut [c64], ldz: usize,
              work: &mut [c64], lwork: isize, rwork: &mut [f64], iwork: &mut [i32],
              ifail: &mut [i32], info: &mut i32) {
...
pub fn sgges(jobvsl: u8, jobvsr: u8, sort: u8, selctg: Select3F32, n: usize, a: &mut [f32],
             ...
             ldvsr: usize, work: &mut [f32], lwork: isize, bwork: &mut [i32], info: &mut i32) {
...
pub fn dgges(jobvsl: u8, jobvsr: u8, sort: u8, selctg: Select3F64, n: usize, a: &mut [f64],
             ...
             ldvsr: usize, work: &mut [f64], lwork: isize, bwork: &mut [i32], info: &mut i32) {
...
pub fn cgges(jobvsl: u8, jobvsr: u8, sort: u8, selctg: Select2C32, n: usize, a: &mut [c32],
             ...
             work: &mut [c32], lwork: isize, rwork: &mut [f32], bwork: &mut [i32],
             info: &mut i32) {
...
pub fn zgges(jobvsl: u8, jobvsr: u8, sort: u8, selctg: Select2C64, n: usize, a: &mut [c64],
             ...
             work: &mut [c64], lwork: isize, rwork: &mut [f64], bwork: &mut [i32],
             info: &mut i32) {
...
pub fn sggev(jobvl: u8, jobvr: u8, n: usize, a: &mut [f32], lda: usize, b: &mut [f32], ldb: usize,
             ...
             vr: &mut [f32], ldvr: usize, work: &mut [f32], lwork: isize, info: &mut i32) {
...
pub fn dggev(jobvl: u8, jobvr: u8, n: usize, a: &mut [f64], lda: usize, b: &mut [f64], ldb: usize,
             ...
             vr: &mut [f64], ldvr: usize, work: &mut [f64], lwork: isize, info: &mut i32) {
...
pub fn cggev(jobvl: u8, jobvr: u8, n: usize, a: &mut [c32], lda: usize, b: &mut [c32], ldb: usize,
             ...
             ldvr: usize, work: &mut [c32], lwork: isize, rwork: &mut [f32], info: &mut i32) {
...
pub fn zggev(jobvl: u8, jobvr: u8, n: usize, a: &mut [c64], lda: usize, b: &mut [c64], ldb: usize,
             ...
             ldvr: usize, work: &mut [c64], lwork: isize, rwork: &mut [f64], info: &mut i32) {
...
pub fn sggevx(balanc: u8, jobvl: u8, jobvr: u8, sense: u8, n: usize, a: &mut [f32], lda: usize,
              ...
              lwork: isize, iwork: &mut [i32], bwork: &mut [i32], info: &mut i32) {
...
#[inline]
pub fn sbbcsd(jobu1: u8, jobu2: u8, jobv1t: u8, jobv2t: u8, trans: u8, m: usize, p: usize,
              q: usize, theta: &mut [f32], phi: &mut [f32], u1: &mut [f32], ldu1: usize,
    ...
    unsafe {
        ffi::sbbcsd_(&(jobu1 as c_char), &(jobu2 as c_char), &(jobv1t as c_char),
                     &(jobv2t as c_char), &(trans as c_char), &(m as c_int), &(p as c_int),
                     &(q as c_int), theta.as_mut_ptr(), phi.as_mut_ptr(), u1.as_mut_ptr(),
...
#[inline]
pub fn dbbcsd(jobu1: u8, jobu2: u8, jobv1t: u8, jobv2t: u8, trans: u8, m: usize, p: usize,
              q: usize, theta: &mut [f64], phi: &mut [f64], u1: &mut [f64], ldu1: usize,
...
#[inline]
pub fn cbbcsd(jobu1: u8, jobu2: u8, jobv1t: u8, jobv2t: u8, trans: u8, m: usize, p: usize,
              q: usize, theta: &mut [f32], phi: &mut [f32], u1: &mut [c32], ldu1: usize,
    ...
    unsafe {
        ffi::cbbcsd_(&(jobu1 as c_char), &(jobu2 as c_char), &(jobv1t as c_char),
                     &(jobv2t as c_char), &(trans as c_char), &(m as c_int), &(p as c_int),
                     &(q as c_int), theta.as_mut_ptr(), phi.as_mut_ptr(),
...
#[inline]
pub fn zbbcsd(jobu1: u8, jobu2: u8, jobv1t: u8, jobv2t: u8, trans: u8, m: usize, p: usize,
              q: usize, theta: &mut [f64], phi: &mut [f64], u1: &mut [c64], ldu1: usize,
...
#[inline]
pub fn cunbdb(trans: u8, signs: u8, m: usize, p: usize, q: usize, x11: &mut [c32], ldx11: usize,
    ...
    unsafe {
        ffi::cunbdb_(&(trans as c_char), &(signs as c_char), &(m as c_int), &(p as c_int),
                     &(q as c_int), x11.as_mut_ptr() as *mut _, &(ldx11 as c_int),
                     x12.as_mut_ptr() as *mut _, &(ldx12 as c_int), x21.as_mut_ptr() as *mut _,
                     &(ldx21 as c_int), x22.as_mut_ptr() as *mut _, &(ldx22 as c_int),
                     theta.as_mut_ptr(), phi.as_mut_ptr(), taup1.as_mut_ptr() as *mut _,
                     taup2.as_mut_ptr() as *mut _, tauq1.as_mut_ptr() as *mut _,
                     tauq2.as_mut_ptr() as *mut _, work.as_mut_ptr() as *mut _, &(lwork as c_int),
                     info)
    }
}

#[inline]
pub fn zunbdb(trans: u8, signs: u8, m: usize, p: usize, q: usize, x11: &mut [c64], ldx11: usize,
    ...
    unsafe {
        ffi::zunbdb_(&(trans as c_char), &(signs as c_char), &(m as c_int), &(p as c_int),
                     &(q as c_int), x11.as_mut_ptr() as *mut _, &(ldx11 as c_int),
                     x12.as_mut_ptr() as *mut _, &(ldx12 as c_int), x21.as_mut_ptr() as *mut _,
                     &(ldx21 as c_int), x22.as_mut_ptr() as *mut _, &(ldx22 as c_int),
                     theta.as_mut_ptr(), phi.as_mut_ptr(), taup1.as_mut_ptr() as *mut _,
...
pub fn cuncsd(jobu1: u8, jobu2: u8, jobv1t: u8, jobv2t: u8, trans: u8, signs: u8, m: usize,
              p: usize, q: usize, x11: &mut [c32], ldx11: &mut u32, x12: &mut [c32],
    ...
    unsafe {
        ffi::cuncsd_(&(jobu1 as c_char), &(jobu2 as c_char), &(jobv1t as c_char),
                     ...
                     &(p as c_int), &(q as c_int), x11.as_mut_ptr() as *mut _,
                     ldx11 as *mut _ as *mut _, x12.as_mut_ptr() as *mut _,
                     ldx12 as *mut _ as *mut _, x21.as_mut_ptr() as *mut _,
                     ldx21 as *mut _ as *mut _, x22.as_mut_ptr() as *mut _,
                     ldx22 as *mut _ as *mut _, theta.as_mut_ptr(), u1.as_mut_ptr() as *mut _,
...
pub fn zuncsd(jobu1: u8, jobu2: u8, jobv1t: u8, jobv2t: u8, trans: u8, signs: u8, m: usize,
              p: usize, q: usize, x11: &mut [c64], ldx11: &mut u32, x12: &mut [c64],
...
#[inline]
pub fn sorbdb(trans: u8, signs: u8, m: usize, p: usize, q: usize, x11: &mut [f32], ldx11: usize,
    ...
    unsafe {
        ffi::sorbdb_(&(trans as c_char), &(signs as c_char), &(m as c_int), &(p as c_int),
                     &(q as c_int), x11.as_mut_ptr(), &(ldx11 as c_int), x12.as_mut_ptr(),
                     &(ldx12 as c_int), x21.as_mut_ptr(), &(ldx21 as c_int), x22.as_mut_ptr(),
                     &(ldx22 as c_int), theta.as_mut_ptr(), phi.as_mut_ptr(), taup1.as_mut_ptr(),
                     taup2.as_mut_ptr(), tauq1.as_mut_ptr(), tauq2.as_mut_ptr(), work.as_mut_ptr(),
                     &(lwork as c_int), info)
    }
}

#[inline]
pub fn dorbdb(trans: u8, signs: u8, m: usize, p: usize, q: usize, x11: &mut [f64], ldx11: usize,
    ...
    unsafe {
        ffi::dorbdb_(&(trans as c_char), &(signs as c_char), &(m as c_int), &(p as c_int),
                     &(q as c_int), x11.as_mut_ptr(), &(ldx11 as c_int), x12.as_mut_ptr(),
                     &(ldx12 as c_int), x21.as_mut_ptr(), &(ldx21 as c_int), x22.as_mut_ptr(),
                     &(ldx22 as c_int), theta.as_mut_ptr(), phi.as_mut_ptr(), taup1.as_mut_ptr(),
                     taup2.as_mut_ptr(), tauq1.as_mut_ptr(), tauq2.as_mut_ptr(), work.as_mut_ptr(),
...
pub fn sorcsd(jobu1: u8, jobu2: u8, jobv1t: u8, jobv2t: u8, trans: u8, signs: u8, m: usize,
              p: usize, q: usize, x11: &mut [f32], ldx11: usize, x12: &mut [f32], ldx12: usize,
              x21: &mut [f32], ldx21: usize, x22: &mut [f32], ldx22: usize, theta: &mut [f32],
              u1: &mut [f32], ldu1: usize, u2: &mut [f32], ldu2: usize, v1t: &mut [f32],
              ldv1t: usize, v2t: &mut [f32], ldv2t: usize, work: &mut [f32], lwork: isize,
              iwork: &mut [i32], info: &mut i32) {

    unsafe {
        ffi::sorcsd_(&(jobu1 as c_char), &(jobu2 as c_char), &(jobv1t as c_char),
                     &(jobv2t as c_char), &(trans as c_char), &(signs as c_char), &(m as c_int),
                     &(p as c_int), &(q as c_int), x11.as_mut_ptr(), &(ldx11 as c_int),
                     x12.as_mut_ptr(), &(ldx12 as c_int), x21.as_mut_ptr(), &(ldx21 as c_int),
                     x22.as_mut_ptr(), &(ldx22 as c_int), theta.as_mut_ptr(), u1.as_mut_ptr(),
                     &(ldu1 as c_int), u2.as_mut_ptr(), &(ldu2 as c_int), v1t.as_mut_ptr(),
                     &(ldv1t as c_int), v2t.as_mut_ptr(), &(ldv2t as c_int), work.as_mut_ptr(),
                     &(lwork as c_int), iwork.as_mut_ptr(), info)
    }
}
...
pub fn dorcsd(jobu1: u8, jobu2: u8, jobv1t: u8, jobv2t: u8, trans: u8, signs: u8, m: usize,
              p: usize, q: usize, x11: &mut [f64], ldx11: usize, x12: &mut [f64], ldx12: usize,
              x21: &mut [f64], ldx21: usize, x22: &mut [f64], ldx22: usize, theta: &mut [f64],
              u1: &mut [f64], ldu1: usize, u2: &mut [f64], ldu2: usize, v1t: &mut [f64],
              ldv1t: usize, v2t: &mut [f64], ldv2t: usize, work: &mut [f64], lwork: isize,
              iwork: &mut [i32], info: &mut i32) {
...
#[inline]
pub fn stpqrt2(m: usize, n: usize, l: usize, a: &mut [f32], lda: usize, b: &mut [f32], ldb: usize,
               t: &mut [f32], ldt: usize, info: &mut i32) {

    unsafe {
        ffi::stpqrt2_(&(m as c_int), &(n as c_int), &(l as c_int), a.as_mut_ptr(), &(lda as c_int),
                      b.as_mut_ptr(), &(ldb as c_int), t.as_mut_ptr(), &(ldt as c_int), info)
    }
}

#[inline]
pub fn dtpqrt2(m: usize, n: usize, l: usize, a: &mut [f64], lda: usize, b: &mut [f64], ldb: usize,
               t: &mut [f64], ldt: usize, info: &mut i32) {

    unsafe {
        ffi::dtpqrt2_(&(m as c_int), &(n as c_int), &(l as c_int), a.as_mut_ptr(), &(lda as c_int),
                      b.as_mut_ptr(), &(ldb as c_int), t.as_mut_ptr(), &(ldt as c_int), info)
    }
}

#[inline]
pub fn ctpqrt2(m: usize, n: usize, l: usize, a: &mut [c32], lda: usize, b: &mut [c32], ldb: usize,
               t: &mut [c32], ldt: usize, info: &mut i32) {

    unsafe {
        ffi::ctpqrt2_(&(m as c_int), &(n as c_int), &(l as c_int), a.as_mut_ptr() as *mut _,
                      &(lda as c_int), b.as_mut_ptr() as *mut _, &(ldb as c_int),
                      t.as_mut_ptr() as *mut _, &(ldt as c_int), info)
    }
}
...
#[inline]
pub fn ztpqrt2(m: usize, n: usize, l: usize, a: &mut [c64], lda: usize, b: &mut [c64], ldb: usize,
               t: &mut [c64], ldt: usize, info: &mut i32) {

    unsafe {
        ffi::ztpqrt2_(&(m as c_int), &(n as c_int), &(l as c_int), a.as_mut_ptr() as *mut _,
                      &(lda as c_int), b.as_mut_ptr() as *mut _, &(ldb as c_int),
                      t.as_mut_ptr() as *mut _, &(ldt as c_int), info)
    }
}
...
#[inline]
pub fn stprfb(side: u8, trans: u8, direct: u8, storev: u8, m: usize, n: usize, k: usize, l: usize,
    ...
    unsafe {
        ffi::stprfb_(&(side as c_char), &(trans as c_char), &(direct as c_char),
                     &(storev as c_char), &(m as c_int), &(n as c_int), &(k as c_int),
                     &(l as c_int), v.as_ptr(), &(ldv as c_int), t.as_ptr(), &(ldt as c_int),
                     a.as_mut_ptr(), &(lda as c_int), b.as_mut_ptr(), &(ldb as c_int),
                     work.as_ptr(), &(ldwork as c_int))
    }
}

#[inline]
pub fn dtprfb(side: u8, trans: u8, direct: u8, storev: u8, m: usize, n: usize, k: usize, l: usize,
...
#[inline]
pub fn ctprfb(side: u8, trans: u8, direct: u8, storev: u8, m: usize, n: usize, k: usize, l: usize,
    ...
    unsafe {
        ffi::ctprfb_(&(side as c_char), &(trans as c_char), &(direct as c_char),
                     &(storev as c_char), &(m as c_int), &(n as c_int), &(k as c_int),
                     &(l as c_int), v.as_ptr() as *const _, &(ldv as c_int),
                     t.as_ptr() as *const _, &(ldt as c_int), a.as_mut_ptr() as *mut _,
                     &(lda as c_int), b.as_mut_ptr() as *mut _, &(ldb as c_int), work.as_ptr(),
                     &(ldwork as c_int))
    }
}

#[inline]
pub fn ztprfb(side: u8, trans: u8, direct: u8, storev: u8, m: usize, n: usize, k: usize, l: usize,
