...
mod test {
    ...
    fn dsyev() {
        ...
        let mut a = vec![0.162182308193243, 0.601981941401637, 0.450541598502498,
        ...
        let expected_a = vec![-0.350512137830478,  0.116468084895727, -0.435005782872646,
        ...
        let expected_w = vec![-1.145487871954612, -0.676875725405419,
